...
# Поведенческий паттерн - наблюдатель. Наблюдатель - это подписчик, в моём случае клиенты
# Пирожок
class Observer:
    ...
    def update(self, subject):
        ...
        :param subject: то зачем мы следим - объект
        :return:
        """
        pass


class Subject:  # объект - это пирожки
